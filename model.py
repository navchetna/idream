...
### Answer:
You are a helpful, respectful, and honest assistant. Answer clearly in 2–3 sentences (under 100 tokens). Use only relevant information from the context. If you don't know, say you don't know.
"""
...
### Answer:
You are a helpful, respectful, and honest assistant. Answer clearly in 2–3 sentences (under 100 tokens). If you don't know, say you don't know.
"""
...
def generate_text(class_range: str, query: str):
    ...
    similar_docs = knowledgeBase.similarity_search(query, k=3)
    filtered_docs = [
